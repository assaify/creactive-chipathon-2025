...
compose l_vec  values 0.70u 0.72u 0.74u 0.76u 0.78u
+ 0.80u 0.90u 1u 2u 3u
  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vb $var4
        run
        wrdata techsweep_nfet_06v0.txt noise1.all
        destroy all
        set appendwrite
