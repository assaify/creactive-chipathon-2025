...
N 450 -290 450 -230 {lab=#net5}
N 450 -250 570 -250 {lab=#net5}
N 540 -340 700 -340 {lab=#net5}
N 540 -340 540 -250 {lab=#net5}
...
N 960 -290 960 -230 {lab=#net7}
N 1080 -290 1080 -230 {lab=#net8}
N 1080 -250 1200 -250 {lab=#net8}
N 1170 -340 1330 -340 {lab=#net8}
N 1170 -340 1170 -250 {lab=#net8}
...
N 700 -810 760 -810 {lab=VDD}
N 690 -420 750 -420 {lab=VDD}
N 1320 -420 1380 -420 {lab=VDD}
...
C {libs/core_ota/input_pair/input_pair.sym} 400 -580 0 0 {name=x1}
C {libs/core_ota/output_stage/output_stage.sym} 750 -730 0 0 {name=x3}
C {libs/core_ota/miller_cap/miller_cap.sym} 700 -630 0 0 {name=x4}
C {libs/core_ota/nulling_res/nulling_res.sym} 610 -630 0 0 {name=x5}
...
C {libs/core_ota/input_pair/input_pair.sym} 390 -190 0 0 {name=x6}
...
C {libs/core_ota/input_pair/input_pair.sym} 1020 -190 0 0 {name=x11}
...
C {libs/core_ota/miller_cap/miller_cap.sym} 1320 -240 0 0 {name=x14}
C {libs/core_ota/nulling_res/nulling_res.sym} 600 -240 0 0 {name=x10}
C {libs/core_ota/nulling_res/nulling_res.sym} 1230 -240 0 0 {name=x15}
C {lab_pin.sym} 1130 -680 0 1 {name=p37 sig_type=std_logic lab=OUT[2]}
C {lab_pin.sym} 1180 -660 0 1 {name=p38 sig_type=std_logic lab=I1C}
C {libs/core_ota/active_load/active_load.sym} 400 -730 0 0 {name=x2}
