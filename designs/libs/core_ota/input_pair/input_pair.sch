...
P 4 5 640 -230 1000 -230 1000 -140 640 -140 640 -230 {}
...
N 690 -210 730 -210 {lab=D1}
N 690 -210 690 -160 {lab=D1}
N 690 -160 690 -150 {lab=D1}
N 690 -150 730 -150 {lab=D1}
N 860 -210 900 -210 {lab=D2}
N 860 -210 860 -150 {lab=D2}
N 860 -150 900 -150 {lab=D2}
...
C {lab_pin.sym} 730 -180 0 1 {name=p6 sig_type=std_logic lab=VSS}
C {symbols/nfet_03v3.sym} 710 -180 0 0 {name=M3
L=0.8u
W=3.78u
nf=1
m=2
...
C {symbols/nfet_03v3.sym} 880 -180 0 0 {name=M4
L=0.8u
W=3.78u
nf=1
m=2
...
C {lab_pin.sym} 690 -180 0 0 {name=p14 sig_type=std_logic lab=D1}
C {lab_pin.sym} 900 -180 0 1 {name=p15 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 860 -180 0 0 {name=p16 sig_type=std_logic lab=D2}
