...
N 570 -410 800 -410 {lab=#net3}
N 800 -420 800 -410 {lab=#net3}
N 690 -410 690 -390 {lab=#net3}
N 690 -270 690 -250 {lab=gnd}
N 390 -250 690 -250 {lab=gnd}
N 390 -270 390 -250 {lab=gnd}
...
C {lab_pin.sym} 390 -250 0 0 {name=p2 sig_type=std_logic lab=gnd}
...
C {code_shown.sym} -250 -710 0 0 {name=s1 only_toplevel=false value="
.option wnflag=1
.option safecurrents
.option solver=klu
...
.endc
"}
C {devices/code_shown.sym} -250 -840 0 0 {name=MODELS only_toplevel=true
