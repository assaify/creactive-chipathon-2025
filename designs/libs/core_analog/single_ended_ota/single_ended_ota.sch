...
S {}
E {}
P 4 5 280 -140 280 -560 1210 -560 1210 -140 280 -140 {}
...
N 560 -420 560 -370 {lab=#net1}
N 790 -420 790 -370 {lab=#net2}
N 600 -480 750 -480 {lab=#net1}
N 670 -480 670 -420 {lab=#net1}
N 560 -420 670 -420 {lab=#net1}
N 420 -220 640 -220 {lab=IBIAS}
N 560 -310 560 -300 {lab=#net3}
N 560 -290 790 -290 {lab=#net3}
N 790 -310 790 -300 {lab=#net3}
...
N 1020 -480 1070 -480 {lab=#net2}
N 1000 -480 1020 -480 {lab=#net2}
N 380 -360 380 -330 {lab=IBIAS}
N 380 -330 380 -250 {lab=IBIAS}
N 940 -480 1000 -480 {lab=#net2}
...
N 560 -300 560 -290 {lab=#net3}
N 790 -300 790 -290 {lab=#net3}
N 680 -290 680 -250 {lab=#net3}
N 560 -340 790 -340 {lab=vss}
N 680 -360 680 -340 {lab=vss}
N 790 -450 790 -420 {lab=#net2}
N 560 -450 560 -420 {lab=#net1}
N 790 -410 950 -410 {lab=#net2}
N 930 -480 940 -480 {lab=#net2}
N 930 -470 930 -410 {lab=#net2}
...
N 930 -480 930 -470 {lab=#net2}
N 1090 -410 1110 -410 {lab=OUT}
N 1010 -410 1030 -410 {lab=#net4}
...
spiceprefix=X
m=10}
C {lab_pin.sym} 980 -430 1 0 {name=p12 sig_type=std_logic lab=VSS}
