...
N 1020 -490 1070 -490 {lab=#net4}
N 850 -490 860 -490 {lab=#net2}
N 920 -490 930 -490 {lab=#net7}
N 800 -490 850 -490 {lab=#net2}
N 530 -450 530 -380 {lab=INVERTING}
N 840 -450 840 -380 {lab=NON_INV}
...
C {lab_pin.sym} 530 -380 0 1 {name=p5 sig_type=std_logic lab=INVERTING}
C {lab_pin.sym} 840 -380 0 0 {name=p6 sig_type=std_logic lab=NON_INV}
