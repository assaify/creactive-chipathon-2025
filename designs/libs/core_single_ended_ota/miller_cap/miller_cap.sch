...
C {symbols/cap_mim_2f0fF.sym} 370 -260 1 0 {name=C1
W=10e-6
L=10e-6
model=cap_mim_2f0fF
spiceprefix=X
m=30}
C {lab_pin.sym} 340 -260 0 0 {name=p1 sig_type=std_logic lab=A}
C {lab_pin.sym} 400 -260 0 1 {name=p2 sig_type=std_logic lab=B}
C {symbols/cap_mim_2f0fF.sym} 590 -260 1 0 {name=C2
W=10e-6
L=10e-6
model=cap_mim_2f0fF
spiceprefix=X
