...
B 2 610 -1690 1410 -1290 {flags=graph
y1=-75
y2=42
ypos1=0
ypos2=2
...
C {code_shown.sym} 10 -750 0 0 {name=s1 only_toplevel=false value="
.option wnflag=1
.option safecurrents
.option solver=klu
...
op
show
write tb_single_ended_ota_v3.raw
*dc vin1 -1 4 0.1
*tran 10n 30u
ac dec 100 1 100e9
...
descr="load ac" 
tclcommand="xschem raw_read $netlist_dir/tb_single_ended_ota_v3.raw ac"
}
...
C {isource.sym} 770 -340 0 0 {name=IBIAS value=260u}
...
C {lab_pin.sym} 780 -770 2 1 {name=p6 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 820 -770 2 0 {name=p8 sig_type=std_logic lab=IBIAS}
C {devices/lab_pin.sym} 690 -660 0 0 {name=p13 sig_type=std_logic lab=INVERTING}
...
C {libs/core_analog/single_ended_ota/single_ended_ota_v3.sym} 780 -680 0 0 {name=x2}
